...
This whole example is inside the examples folder for flame, and you can see the code, if you have any doubts, [here](https://github.com/luanpotter/flame/tree/master/doc/examples/animation_widget). This whole article is also commited [here](https://github.com/luanpotter/flame/tree/master/doc/animation_widget_article).
