...
The `BaseSystem` is an abstract class. Its logic can be compared to the `PositionComponent`
...
The following components will be checked by `BaseSystem` for the preparation of the
canvas:
