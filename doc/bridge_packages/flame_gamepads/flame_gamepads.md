...
**flame_gamepads** provides helping bridge functionality to use the `gamepads` package in your flame game.
...
See the lib [gamepads](https://github.com/flame-engine/gamepads.dart) for more info on how to process the
NormalizedGamepadEvent data.
