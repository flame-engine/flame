...
useful when trying to create non-default looking buttons. For example when creating that look it is
more easily achieved by drawing the button in a graphics software, instead of making it directly in
Flutter.
