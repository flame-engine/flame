...
import 'package:doc_flame_examples/snippet_hud_controls.dart';
import 'package:doc_flame_examples/snippet_physics_arc.dart';
...
void main() {
  ...
  final routes = <String, Game Function()>{
    ...
    'snippet_hud_controls': SnippetHudControlsGame.new,
    'snippet_physics_arc': SnippetPhysicsArcGame.new,
