...
```{note}
This document describes the new tap events API. It is important to note that when the first
tappable component is added to the game, `FlameGame` must temporarily remove itself and run the
