...
import 'package:examples/stories/bridge_libraries/forge2d/Draggables_example.dart';
...
void addForge2DStories(Dashbook dashbook) {
  dashbook.storiesOf('flame_forge2d')
    ...
    ..add(
      'Draggables Body',
      (DashbookContext ctx) => GameWidget(game: DraggablesExample()),
      codeLink: link('Draggables_example.dart'),
