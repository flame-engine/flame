...
import 'package:flutter/material.dart' hide Draggables;

class DraggablesExample extends Forge2DGame with HasDraggables {
  static const description = '''
    In this example we use Flame's normal `Draggables` mixin to give impulses to
  ...
  DraggablesExample() : super(gravity: Vector2.all(0.0));
  ...
  Future<void> onLoad() async {
    ...
    add(DraggablesBall(center));
  }
}

class DraggablesBall extends Ball with Draggables {
  DraggablesBall(super.position) : super(radius: 5) {
