...
class CloudManager extends PositionedComponent with HasGameReference<TRexGame> {
  ...
  void addCloud() {
    final cloudPosition = Vector2(
      ...
      ((absolutePosition.y / 2 - (Cloud.maxSkyLevel - Cloud.minSkyLevel)) + random.fromRange(Cloud.minSkyLevel, Cloud.maxSkyLevel)) - absolutePosition.y,
    );
