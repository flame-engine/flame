...
void main() {
  group('Components - HasPaint', () {
    ...
    test('paint setter sets the main paint', () {
      final comp = MyComponent();
    ...
    test('deletePaint removes a paint from the map', () {
      final comp = MyComponent();
    ...
    test('deletePaint cannot remove the main paint', () {
      final comp = MyComponent();
    ...
    test('makeTransparent sets opacity to 0 on informed paintId', () {
      final comp = MyComponent();
      comp.setPaint('background', Paint());
    ...
    test('makeOpaque sets opacity to 1 on the main when paintId is omitted',
        () {
      final comp = MyComponent();
      comp.makeTransparent();
      comp.makeOpaque();
    ...
    test('makeOpaque sets opacity to 1 on informed paintId', () {
      final comp = MyComponent();
    ...
    test('setOpacity sets opacity of the main when paintId is omitted', () {
      final comp = MyComponent();
      comp.setOpacity(0.2);
    ...
    test('setOpacity sets opacity of the informed paintId', () {
      final comp = MyComponent();
      comp.setPaint('background', Paint());
    ...
    test('throws error if opacity is less than 0', () {
      final comp = MyComponent();
    ...
    test('throws error if opacity is greater than 1', () {
      final comp = MyComponent();
    ...
    test('setColor sets color of the main when paintId is omitted', () {
      final comp = MyComponent();
      const color = Color(0xFFE5E5E5);
      comp.setColor(color);
