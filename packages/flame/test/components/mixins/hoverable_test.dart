...
void main() {
  group('Hoverables', () {
    testWithGame<_GameWithHoverables>(
      ...
      (game) async {
        await game.add(_HoverablesComponent());
        await game.ready();
      },
    );
    ...
    testWithGame<_GameWithHoverables>(
      ...
      _GameWithHoverables.new,
      (game) async {
        final a = _HoverablesComponent()
          ..position = Vector2(10, 0)
          ..size = Vector2(2, 20);
        final b = _HoverablesComponent()
    ...
    testWithGame<_GameWithHoverables>(
      ...
      _GameWithHoverables.new,
      (game) async {
        final parent = _HoverablesComponent()
...
class _HoverablesComponent extends PositionComponent with Hoverables {
  int enterCount = 0;
  int leaveCount = 0;
...
class _NonPropagatingComponent extends _HoverablesComponent {
  @override
  bool onHoverEnter(PointerHoverInfo info) {
