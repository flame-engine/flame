...
void main() {
  group('MoveAlongPathEffect', () {
      ...
      for (var i = 0; i < 60; i++) {
        if (i <= 15) {
          ...
          expect(
            component.angle, 
            closeTo(
              -asin(0.8) + component.nativeAngle,
              1e-7,
            ),
          );
        } else if (i <= 35) {
          ...
          expect(
            component.angle, 
            closeTo(
              -asin(0.6) + component.nativeAngle,
              1e-7,
            ),
          );
        } else {
    ...
    testWithFlameGame('absolute oriented path w/nativeAngle', (game) async {
      final component = PositionComponent(
        position: Vector2(17, -5),
        angle: -30.5,
        nativeAngle: 20.5,
    ...
    testWithFlameGame('non-absolute oriented path w/nativeAngle', (game) async {
      final component = PositionComponent(
        position: Vector2.zero(),
        angle: -30.5,
        nativeAngle: 20.5,
