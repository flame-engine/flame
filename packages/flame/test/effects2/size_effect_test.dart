...
void main() {
  group('SizeEffect', () {
    flameGame.test('relative', (game) {
      ...
      component.add(
        SizeEffect.by(Vector2.all(1.0), standardController(duration: 1)),
      );
      game.update(0);
    ...
    flameGame.test('absolute', (game) {
      ...
      component.size = Vector2.all(1.0);
      component.add(
        SizeEffect.to(Vector2.all(3.0), standardController(duration: 1)),
      );
      game.update(0);
      expectVector2(component.size, Vector2.all(1.0));
      expect(component.children.length, 1);
    ...
    flameGame.test('size composition', (game) {
      ...
      component.add(
        SizeEffect.by(Vector2.all(5), standardController(duration: 10)),
      );
      component.add(
        SizeEffect.by(
          Vector2.all(0.5),
