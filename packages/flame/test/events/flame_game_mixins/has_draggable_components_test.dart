  ...
  group('HasDraggablesComponents', () {
    testWidgets(
      ...
      (tester) async {
        ...
        final game = _GameWithHasDraggablesComponents(
          children: [
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        var nDraggablesUpdates = 0;
        final game = _GameWithDualDraggablesComponents(
          children: [
            _DragCallbacksComponent(
              size: Vector2.all(100),
        ...
        expect(nDraggablesUpdates, 62);
      },
    );
  });
}

class _GameWithHasDraggablesComponents extends FlameGame
    with HasDraggablesComponents {
  _GameWithHasDraggablesComponents({super.children});
}

class _GameWithDualDraggablesComponents extends FlameGame
    with HasDraggablesComponents, HasDraggablesBridge {
  _GameWithDualDraggablesComponents({super.children});
}
...
class _DraggablesComponent extends PositionComponent with Draggables {
  _DraggablesComponent({
    super.size,
