...
void main() {
  final withHasDraggablesComponents =
      FlameTester(_GameWithHasDraggablesComponents.new);

  group('DragCallbacks', () {
    testWithGame<_GameWithHasDraggablesComponents>(
      'make sure they can be added to game with HasDraggablesComponents',
      _GameWithHasDraggablesComponents.new,
      (game) async {
      ...
      (game) async {
        expect(
          ...
          failsAssert(
            ...
            'FlameGame with '
            'the HasDraggablesComponents mixin',
          ),
        );
      },
    );
    ...
    withHasDraggablesComponents.testGameWidget(
