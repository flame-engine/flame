  ...
  group('projections', () {
    ...
    testWithFlameGame(
      ...
      (game) async {
        ...
        // position the zoom is still applied w.r.t. the top left of the screen.
    ...
    testWithFlameGame(
      ...
      (game) async {
        ...
        // which means 100 viewport units above the top left of the camera
        // (10, 10) each viewport unit is twice the camera unit, so that is 50
        // above.
        expect(
          game.projector.unprojectVector(Vector2.zero()),
          Vector2(10, -40),
