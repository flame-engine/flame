...
> Note: This release has breaking changes.
 ...
 - **BREAKING** **FIX**: Remove pointerId from Draggables callbacks (#1313). ([27adda17](https://github.com/flame-engine/flame/commit/27adda17b7b4d8c229cca53799826c7b854eae95))
...
## [1.0.0-releasecandidate.17]
 ...
 - Rename `HasDraggablesComponents` to `HasDraggables`
 - Rename `HasHoverablesComponents` to `HasHoverablesis`
...
## [1.0.0-releasecandidate.15]
 - Fix issue with `Draggables`s not being removed from `Draggables` list
