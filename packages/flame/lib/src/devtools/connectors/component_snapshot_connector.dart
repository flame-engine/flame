...
/// `ext.flame_devtools.getComponentTree` service extension.
class ComponentSnapshotConnector extends DevToolsConnector {
    ...
    registerExtension(
      ...
      (method, parameters) async {
        ...
        final snapshot = component == null
            ? ''
            : await encodePng(snapshotComponent(component));
  ...
  /// Renders [component] and its children to an image.
  ///
  ...
  static Image snapshotComponent(Component component) {
    ...
    if (component is PositionComponent) {
      ...
      width = max(rect.width.ceil(), 1);
      height = max(rect.height.ceil(), 1);
