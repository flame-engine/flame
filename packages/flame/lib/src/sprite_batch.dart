...
enum SpriteBatchFlippedAtlasStatus {
  ...
  /// Flipped atlas is generating but not available for now.
  generateInProgress,

  /// Flipped atlas is available.
  ready,
  ;
...
class SpriteBatch {
  ...
  /// The sources to use on the [flippedAtlas].
  ...
  /// The transforms that should be applied on the [_flippedSources].
  ...
  /// The background color for the [_flippedSources].
  ...
  /// The horizontally flipped atlas generated by the [atlas].
  ...
  void addTransform({
    ...
    if (flip && useAtlas && flippedAtlasStatus.isNone) {
      _makeFlippedAtlas();
    }
