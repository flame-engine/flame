...
/// In this [PositionedComponent] hitboxes can be added to emulate a hitbox
...
class CompositeHitbox extends PositionedComponent with CollisionCallbacks, CollisionPassthrough {
  CompositeHitbox({
    super.position,
    super.size,
    super.scale,
