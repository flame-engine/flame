...
/// [HasGameRef] mixin provides property [gameRef], which is the cached accessor
/// for the top-level game instance.
///
/// The type [T] on the mixin is the type of your game class. This type will be
/// the type of the [gameRef] reference, and the mixin will check at runtime
...
mixin HasGameRef<T extends FlameGame> on Component {
  ...
  T get gameRef => _game ??= _findGameAndCheck();
  ...
  /// instance.
  set gameRef(T? value) => _game = value;
