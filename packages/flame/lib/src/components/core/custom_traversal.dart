...
/// The marker interface for components that manage the update traversal of
/// their own subtree, instead of the engine's standard "update self, then
/// update every child in priority order" recursion.
///
/// Implement this (and override [Component.updateSubtree]) to customize the
/// traversal. The interface is both the capability and the barrier marker: the
...
abstract interface class CustomTraversal implements Component {}
