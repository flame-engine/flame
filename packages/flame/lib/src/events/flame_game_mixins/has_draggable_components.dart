...
/// - If your game also uses [Draggables] components, then add the
///   [HasDraggablesBridge] mixin as well (instead of `HasDraggables`).
/// - If your game has no Draggables components, then do not use this mixin.
///   Instead, consider using [MultiTouchDragDetector].
mixin HasDraggablesComponents on FlameGame implements MultiDragListener {
  ...
  ///
  /// If [HasDraggablesComponents] is the only pointer events mixin in use, then
  ...
  void onDragStart(DragStartEvent event) {
    ...
    if (this is HasDraggablesBridge) {
      ...
      propagateToChildren<Draggables>(
