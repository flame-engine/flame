...
///
/// See [MultiDragListener] for the description of each individual event. If
/// your game is derived from the FlameGame class, consider using the
/// [HasDraggablesComponents] mixin instead.
