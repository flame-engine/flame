...
Here you can see a [working example](./examples/with_widgets_overlay) of this feature.
...
To see more about debugMode on Flame, please refer to the [Debug Docs](./debug.md)
