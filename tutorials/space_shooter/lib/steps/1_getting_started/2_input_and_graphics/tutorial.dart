...
that actually renders something, so we don't need to override it anymore.
 - `FlameGame` has a couple of methods for loading assets, like `loadSprite`. When those methods 
are used, `FlameGame` will take care of cleaning any cache when the game
