...
Packages with breaking changes:
 ...
 - [`flame_audio` - `v3.0.0`](#flame_audio---v300)
 - [`flame_bloc` - `v2.0.0`](#flame_bloc---v200)
 - [`flame_fire_atlas` - `v2.0.0`](#flame_fire_atlas---v200)
 - [`flame_forge2d` - `v0.19.0`](#flame_forge2d---v0190)
 - [`flame_isolate` - `v0.7.0`](#flame_isolate---v070)
 - [`flame_lint` - `v2.0.0`](#flame_lint---v200)
 - [`flame_lottie` - `v0.5.0`](#flame_lottie---v050)
 - [`flame_markdown` - `v0.3.0`](#flame_markdown---v030)
 - [`flame_network_assets` - `v0.4.0`](#flame_network_assets---v040)
 - [`flame_noise` - `v0.4.0`](#flame_noise---v040)
 - [`flame_oxygen` - `v0.3.0`](#flame_oxygen---v030)
 - [`flame_rive` - `v2.0.0`](#flame_rive---v200)
 - [`flame_riverpod` - `v6.0.0`](#flame_riverpod---v600)
 - [`flame_spine` - `v0.3.0`](#flame_spine---v030)
 - [`flame_splash_screen` - `v0.4.0`](#flame_splash_screen---v040)
...
Packages with other changes:
 ...
 - [`flame_sprite_fusion` - `v0.1.4`](#flame_sprite_fusion---v014)
...
#### `flame` - `v2.0.0`
 ...
 - **REFACTOR**: Added classes MoveByEffect and MoveToEffect ([#1524](https://github.com/flame-engine/flame/issues/1524)). ([2171a119](https://github.com/flame-engine/flame/commit/2171a119378855872f6bece37edc95b3d68f28ae))
 ...
 - **REFACTOR**: Simplify GameWidgetState.loaderFuture ([#1232](https://github.com/flame-engine/flame/issues/1232)). ([eb30c2e5](https://github.com/flame-engine/flame/commit/eb30c2e5e9b10e388a9d56283b90e3f09c5f9379))
 ...
 - **REFACTOR**: Component.ancestors() is now an iterator ([#1242](https://github.com/flame-engine/flame/issues/1242)). ([ce48d77a](https://github.com/flame-engine/flame/commit/ce48d77ad72a3c5f865c7ec40b753678a2fbebe4))
 ...
 - **REFACTOR**: Removed parameter Component.updateTree({callOwnUpdate}) ([#1224](https://github.com/flame-engine/flame/issues/1224)). ([ed227e7c](https://github.com/flame-engine/flame/commit/ed227e7c74bae51061e9622fe6852cf020ce6fa6))
 ...
 - **REFACTOR**: Loadable mixin no longer declares onMount and onRemove ([#1243](https://github.com/flame-engine/flame/issues/1243)). ([b1f6a34c](https://github.com/flame-engine/flame/commit/b1f6a34c198a732d51471bf0b79a71a4f3e60973))
 ...
 - **REFACTOR**: Resize logic in GameRenderBox ([#1308](https://github.com/flame-engine/flame/issues/1308)). ([17c45c28](https://github.com/flame-engine/flame/commit/17c45c28291862ba2c7c079fe91e994a71b1d807))
 - **REFACTOR**: Use canvas.drawImageNine in NineTileBox ([#1314](https://github.com/flame-engine/flame/issues/1314)). ([d77e5efe](https://github.com/flame-engine/flame/commit/d77e5efee573ddcbc84a50be7728d7a9207287f7))
 - **REFACTOR**: Loadable no longer declares onGameResize ([#1329](https://github.com/flame-engine/flame/issues/1329)). ([20776e86](https://github.com/flame-engine/flame/commit/20776e8659bda57813ddc14856502d4b07b85fef))
 - **REFACTOR**: Remove Loadable, optional onLoads ([#1333](https://github.com/flame-engine/flame/issues/1333)). ([05f7a4c3](https://github.com/flame-engine/flame/commit/05f7a4c3d6b1e3b67575c4ec920cf270691bbab4))
 ...
 - **REFACTOR**: Clean up of top-level tests ([#1386](https://github.com/flame-engine/flame/issues/1386)). ([e50003ed](https://github.com/flame-engine/flame/commit/e50003ed609fabe4268ceaa1e728b6f29f05939e))
 ...
 - **REFACTOR**: Parent change and component removal logic ([#1385](https://github.com/flame-engine/flame/issues/1385)). ([8b9fa352](https://github.com/flame-engine/flame/commit/8b9fa3521cc44f7696c5ce0b396e3007c2ae7e8c))
 ...
 - **REFACTOR**: Organize tests in the game/ folder ([#1403](https://github.com/flame-engine/flame/issues/1403)). ([102a27cc](https://github.com/flame-engine/flame/commit/102a27cc75d15e1c0ec867d739c9ce3f7feaff56))
 ...
 - **PERF**: Allow components to have null children ([#1231](https://github.com/flame-engine/flame/issues/1231)). ([66ad4b08](https://github.com/flame-engine/flame/commit/66ad4b08af6153fb767667a7bed42dac6fb8f2c7))
 ...
 - **FIX**: `prepareComponent` should never run again on a prepared component ([#1237](https://github.com/flame-engine/flame/issues/1237)). ([7d3eeb73](https://github.com/flame-engine/flame/commit/7d3eeb73c588f2465472cd6069f28d6136b0721d))
 - **FIX**: Component.propagateToChildren() order of traversal ([#1483](https://github.com/flame-engine/flame/issues/1483)). ([e6312e6f](https://github.com/flame-engine/flame/commit/e6312e6fea424e2a9c34304c544018a8f2ad7f1e))
 ...
 - **FIX**: Remove generics from ancestors ([#1482](https://github.com/flame-engine/flame/issues/1482)). ([b37854c8](https://github.com/flame-engine/flame/commit/b37854c8654f73ec5fa25c3c0a40194c161a1ba3))
 ...
 - **FIX**: Game-in-Game scenario ([#1490](https://github.com/flame-engine/flame/issues/1490)). ([9566564c](https://github.com/flame-engine/flame/commit/9566564ce636bc4752bb0b68a414d175c7568de9))
 - **FIX**: Only end collisions where there was a collision ([#1471](https://github.com/flame-engine/flame/issues/1471)). ([e1e87fc4](https://github.com/flame-engine/flame/commit/e1e87fc42226c1db2f472377901031277349beb3))
 - **FIX**: Add missing `priority` argument for `JoystickComponent` ([#1227](https://github.com/flame-engine/flame/issues/1227)). ([23b1dd8b](https://github.com/flame-engine/flame/commit/23b1dd8bbcc98ae3c59a86c10e03b074982b6adc))
 ...
 - **FIX**: Fix calculation of AABB for `ShapeHitbox`es ([#1481](https://github.com/flame-engine/flame/issues/1481)). ([a559d9a1](https://github.com/flame-engine/flame/commit/a559d9a12bfb42e161469745795fb91cdf161f8b))
 ...
 - **FIX**: HudMarginComponent positioning on zoom ([#1250](https://github.com/flame-engine/flame/issues/1250)). ([4f0fb2de](https://github.com/flame-engine/flame/commit/4f0fb2de6f12ad950705ddb75ebd2e80114321e5))
 ...
 - **FIX**(NA): black frame when activating overlays ([#1093](https://github.com/flame-engine/flame/issues/1093)). ([85caf463](https://github.com/flame-engine/flame/commit/85caf463f48ce34fdf51bfd0f511c8188dcf4481))
 ...
 - **FIX**: `debugMode` should be inherited from parent when mounted ([#1469](https://github.com/flame-engine/flame/issues/1469)). ([e894d201](https://github.com/flame-engine/flame/commit/e894d20133f6e142c67286c449135e37e892f35b))
 ...
 - **FIX**: Call onCollisionEnd on removal of Collidable ([#1247](https://github.com/flame-engine/flame/issues/1247)). ([5ddcc6f7](https://github.com/flame-engine/flame/commit/5ddcc6f7baaae60996747d37b4d92f4f890c7fa2))
 ...
 - **FIX**: Allow most basic and advanced gesture detectors together ([#1208](https://github.com/flame-engine/flame/issues/1208)). ([5828b6f3](https://github.com/flame-engine/flame/commit/5828b6f369b74b8f1ab2cc42905c647bbc7dfda5))
 - **FIX**: Both places should have `strictMode = false` ([#1272](https://github.com/flame-engine/flame/issues/1272)). ([72161ad8](https://github.com/flame-engine/flame/commit/72161ad8d2f2a0916f4448d67644272fdc9ceace))
 - **FIX**: Fix SpriteAnimationWidget lifecycle ([#1212](https://github.com/flame-engine/flame/issues/1212)). ([86394dd3](https://github.com/flame-engine/flame/commit/86394dd3e05079494c7c3c000c3104712faf7507))
 ...
 - **FIX**: redrawing bug in TextBoxComponent ([#1279](https://github.com/flame-engine/flame/issues/1279)). ([8bef4805](https://github.com/flame-engine/flame/commit/8bef480597024f51ac2e4f534e1977f53d768df2))
 ...
 - **FIX**: `@mustCallSuper` missing on components ([#1443](https://github.com/flame-engine/flame/issues/1443)). ([e01b4b1a](https://github.com/flame-engine/flame/commit/e01b4b1ac3e423037fa313672b4882e7d29210b8))
 ...
 - **FIX**: Setting images.prefix to empty string ([#1437](https://github.com/flame-engine/flame/issues/1437)). ([694102bd](https://github.com/flame-engine/flame/commit/694102bd0304736ed3bdfbd596d64901d7adf57f))
 ...
 - **FIX**: Add missing paint argument to `SpriteComponent.fromImage` ([#1294](https://github.com/flame-engine/flame/issues/1294)). ([254a60c8](https://github.com/flame-engine/flame/commit/254a60c8475da218a61d2b179d894f469efe5486))
 ...
 - **FIX**: Properly dispose images when cache is cleared ([#1312](https://github.com/flame-engine/flame/issues/1312)). ([825fb0cc](https://github.com/flame-engine/flame/commit/825fb0cc7e5b30911e17a2075e28f74c8d69b593))
 ...
 - **FIX**: Deprecate Images.decodeImageFromPixels ([#1318](https://github.com/flame-engine/flame/issues/1318)). ([1a80130c](https://github.com/flame-engine/flame/commit/1a80130c6632cc8b1f34c19aa928ac66364ecbe5))
 - **FIX**: Deprecate pause and resume in GameLoop ([#1240](https://github.com/flame-engine/flame/issues/1240)). ([dc37053f](https://github.com/flame-engine/flame/commit/dc37053fb6ed46bb68cebab0ed82248051ddf86a))
 ...
 - **FIX**: viewfinders behavior under zoom ([#1432](https://github.com/flame-engine/flame/issues/1432)). ([f3cf85b6](https://github.com/flame-engine/flame/commit/f3cf85b638cc71058e85756498e79971a1942491))
 ...
 - **FIX**: change strokeWidth in Component ([#1431](https://github.com/flame-engine/flame/issues/1431)). ([0e174fe8](https://github.com/flame-engine/flame/commit/0e174fe8e5f1262af41c8659c0fce7ed060e69a9))
 ...
 - **FIX**: `ParallaxComponent` should have static `positionType` ([#1350](https://github.com/flame-engine/flame/issues/1350)). ([cfa6bd12](https://github.com/flame-engine/flame/commit/cfa6bd127be620f6016442a269a479d162241a11))
 ...
 - **FIX**: Fix collision detection comments and typo ([#1422](https://github.com/flame-engine/flame/issues/1422)). ([dfeafdd6](https://github.com/flame-engine/flame/commit/dfeafdd6f3e962d6f5148340ab461a9e805652b7))
 ...
 - **FIX**: Make CollisionProspect's a, b have unordered equality ([#1519](https://github.com/flame-engine/flame/issues/1519)). ([5b2471c8](https://github.com/flame-engine/flame/commit/5b2471c8ae29a1313db3b2c21dee6d4654a0132c))
 ...
 - **FIX**: Bug with anchor parameter in Sprite.render() ([#1508](https://github.com/flame-engine/flame/issues/1508)). ([325df46e](https://github.com/flame-engine/flame/commit/325df46e19ebcd5ac13e3192f4360bacb3de1c37))
 ...
 - **FIX**: Invalidate polygon cache on resize ([#1529](https://github.com/flame-engine/flame/issues/1529)). ([11bf75d0](https://github.com/flame-engine/flame/commit/11bf75d074fe9c0d3e043ce43611a1bb1824dd40))
 ...
 - **FIX**: remove vector_math dependency ([#1361](https://github.com/flame-engine/flame/issues/1361)). ([56b33da2](https://github.com/flame-engine/flame/commit/56b33da29cfe547db75c89d97a09550a324fb0f5))
 ...
 - **FIX**: Step time in SpriteAnimation must be positive ([#1387](https://github.com/flame-engine/flame/issues/1387)). ([08e8eac1](https://github.com/flame-engine/flame/commit/08e8eac1734a63111a5b7aba4e1bfd20d503aaf4))
 - **FIX**: flame svg perfomance ([#1373](https://github.com/flame-engine/flame/issues/1373)). ([bce24173](https://github.com/flame-engine/flame/commit/bce2417330b5165842f15d0409a213a1c5ad1cd3))
 ...
 - **FEAT**: Components are now always added in the correct order ([#1337](https://github.com/flame-engine/flame/issues/1337)). ([c753fc46](https://github.com/flame-engine/flame/commit/c753fc4636d337d850a5a5cc684be8155f08b214))
 ...
 - **FEAT**: Added `transform` to `Rect` ([#1360](https://github.com/flame-engine/flame/issues/1360)). ([1818be41](https://github.com/flame-engine/flame/commit/1818be41761015b33aee820a0a02f50327a4df4e))
 ...
 - **FEAT**: exporting cache classes ([#1368](https://github.com/flame-engine/flame/issues/1368)). ([3e058973](https://github.com/flame-engine/flame/commit/3e0589730c49663b5c4863fc28718b3fa81b7b60))
 ...
 - **FEAT**: Added NoiseEffectController ([#1356](https://github.com/flame-engine/flame/issues/1356)). ([fad9d1d5](https://github.com/flame-engine/flame/commit/fad9d1d54f4c3500611f82a9382ffa1fed9b52b8))
 ...
 - **FEAT**: Camera as a component ([#1355](https://github.com/flame-engine/flame/issues/1355)). ([c61a1c18](https://github.com/flame-engine/flame/commit/c61a1c18b5bdd0b27f3ab21d73d8bbddffd48ba2))
 ...
 - **FEAT**: adding has mounted to component ([#1418](https://github.com/flame-engine/flame/issues/1418)). ([f8f9e045](https://github.com/flame-engine/flame/commit/f8f9e0451309bfdd29ec8cefbf9d8187209a314c))
 ...
 - **FEAT**(gestures): Update scale events to contain pan info ([#1327](https://github.com/flame-engine/flame/issues/1327)). ([70b96b07](https://github.com/flame-engine/flame/commit/70b96b071a8e936b5c5d6014cb18277b76c646db))
 ...
 - **FEAT**: allowing changing of the images prefix and allowing empty prefixes ([#1433](https://github.com/flame-engine/flame/issues/1433)). ([de4d9416](https://github.com/flame-engine/flame/commit/de4d941654710add459cc1c923b92c3923556f15))
 ...
 - **FEAT**: Add onReleased callback for HudButtonComponent ([#1296](https://github.com/flame-engine/flame/issues/1296)). ([87ee34ca](https://github.com/flame-engine/flame/commit/87ee34cac72b6d09b8c8f870433541361ff383c1))
 ...
 - **FEAT**(effects): Added SineEffectController ([#1262](https://github.com/flame-engine/flame/issues/1262)). ([c888703d](https://github.com/flame-engine/flame/commit/c888703d6e002fe5f15a82d6204a0639f92aa66a))
 ...
 - **FEAT**(effects): Added SpeedEffectController ([#1260](https://github.com/flame-engine/flame/issues/1260)). ([20f521f5](https://github.com/flame-engine/flame/commit/20f521f5beb5ee476d345d1766a30b4ba35c079b))
 ...
 - **FEAT**(internal): Added RecycledQueue class ([#1864](https://github.com/flame-engine/flame/issues/1864)). ([9457e38e](https://github.com/flame-engine/flame/commit/9457e38ebc2485e235e3bdc01c7ba43097139db7))
 - **FEAT**: Add setter to priority ([#1444](https://github.com/flame-engine/flame/issues/1444)). ([34284686](https://github.com/flame-engine/flame/commit/342846860af36ed73a1fc0a9a76ed9add12cec71))
 ...
 - **FEAT**: Added .anchor property to CameraComponent.Viewfinder ([#1458](https://github.com/flame-engine/flame/issues/1458)). ([d51dc5e1](https://github.com/flame-engine/flame/commit/d51dc5e132bc3ba5763be4de36131d3739a6c906))
 ...
 - **FEAT**(effects): Added ZigzagEffectController ([#1261](https://github.com/flame-engine/flame/issues/1261)). ([59adc5f3](https://github.com/flame-engine/flame/commit/59adc5f34c2eebd336f7d39a703a6845227b55ed))
 ...
 - **FEAT**: Turn off `strictMode` for children ([#1271](https://github.com/flame-engine/flame/issues/1271)). ([6936e1d9](https://github.com/flame-engine/flame/commit/6936e1d98b63c071787d3dea09fad7659bdf0473))
 ...
 - **FEAT**: Deprecating Rect methods ([#1455](https://github.com/flame-engine/flame/issues/1455)). ([4ddd90aa](https://github.com/flame-engine/flame/commit/4ddd90aafc40a3f5ce3d9b181a66369436de3c9c))
 ...
 - **FEAT**: adding loaded future to the component ([#1466](https://github.com/flame-engine/flame/issues/1466)). ([6434829b](https://github.com/flame-engine/flame/commit/6434829b45cc131719fd950ef2d262d0bfbdff1b))
 ...
 - **FEAT**: `onCollisionStart` for `Collidable` and `HitboxShape` ([#1251](https://github.com/flame-engine/flame/issues/1251)). ([9b95686b](https://github.com/flame-engine/flame/commit/9b95686ba57c16c9f029f920150e112d180bd584))
 ...
 - **FEAT**: Add keyboard with focus node implementation ([#909](https://github.com/flame-engine/flame/issues/909)). ([c833319c](https://github.com/flame-engine/flame/commit/c833319c49cb774e6a657a12fd4070de9efd10b7))
 ...
 - **FEAT**: Possibility to mark gesture events as handled ([#1465](https://github.com/flame-engine/flame/issues/1465)). ([4c3960c3](https://github.com/flame-engine/flame/commit/4c3960c3418f8ff4d557c1764c6793468238a8da))
 ...
 - **FEAT**: Added method that returned descendants ([#1461](https://github.com/flame-engine/flame/issues/1461)). ([a41f5376](https://github.com/flame-engine/flame/commit/a41f53762ab49bb3d51f1f96c37b934a7ab83844))
 ...
 - **FEAT**: Added method Images.ready() ([#1441](https://github.com/flame-engine/flame/issues/1441)). ([f81254c1](https://github.com/flame-engine/flame/commit/f81254c181c92c946af785912af6427e6697c5e6))
 ...
 - **FEAT**: Effect.onComplete callback as an alternative to onFinish() ([#1201](https://github.com/flame-engine/flame/issues/1201)). ([932a8111](https://github.com/flame-engine/flame/commit/932a81118b0faba80def677cd0db28a598e15204))
 ...
 - **FEAT**: adding Component.lastChild and Component.firstChild ([#1485](https://github.com/flame-engine/flame/issues/1485)). ([a3b7de0a](https://github.com/flame-engine/flame/commit/a3b7de0acd01249887c670ec6c5a6a9235ad537b))
 ...
 - **FEAT**: Add RandomEffectController ([#1203](https://github.com/flame-engine/flame/issues/1203)). ([cdb2650b](https://github.com/flame-engine/flame/commit/cdb2650b29bee6e8412a666f9f49fabb68ce0265))
 ...
 - **FEAT**: `Component.childrenFactory` can be used to set up a global `ComponentSet` factory ([#1193](https://github.com/flame-engine/flame/issues/1193)). ([223ab758](https://github.com/flame-engine/flame/commit/223ab75886ab018053cd75af33560a03e1b9d470))
 ...
 - **FEAT**: able to clear all overlays ([#1536](https://github.com/flame-engine/flame/issues/1536)). ([7b15c9a1](https://github.com/flame-engine/flame/commit/7b15c9a1ca58c19265e65899e27c65146d42788c))
 - **FEAT**: adding ParticleSystemComponent ([#1489](https://github.com/flame-engine/flame/issues/1489)). ([6891eaaa](https://github.com/flame-engine/flame/commit/6891eaaa24b0cb7120a342dafa03b3a41fba9ff4))
 - **FEAT**: Automatic Isometric Grid scaling ([#1468](https://github.com/flame-engine/flame/issues/1468)). ([cae8c0ce](https://github.com/flame-engine/flame/commit/cae8c0ceb395416ed86fd644c1dd7790eae127ca))
 - **FEAT**: Added children parameter to Component constructor ([#1525](https://github.com/flame-engine/flame/issues/1525)). ([f0b31fcf](https://github.com/flame-engine/flame/commit/f0b31fcfc0fc6b0f8f96895ef6a68fd5a30a3159))
 ...
 - **FEAT**: Camera's Viewfinder can now be affected by rotation effects ([#1527](https://github.com/flame-engine/flame/issues/1527)). ([f46cae04](https://github.com/flame-engine/flame/commit/f46cae040e34f6037a9e0a7e259bf22b9dff7acb))
 - **FEAT**: Scale (zoom) effects can now be applied to Viewfinder in CameraComponent ([#1514](https://github.com/flame-engine/flame/issues/1514)). ([403b6e60](https://github.com/flame-engine/flame/commit/403b6e60433f5e059b81298fd4b39a77957932fb))
 - **FEAT**: adding HasGameRef.mockGameRef ([#1520](https://github.com/flame-engine/flame/issues/1520)). ([4f389f8b](https://github.com/flame-engine/flame/commit/4f389f8b88b181832316bae551e31a3a70907ee7))
 ...
 - **FEAT**: flame tests can now generate golden tests ([#1501](https://github.com/flame-engine/flame/issues/1501)). ([316a0b3b](https://github.com/flame-engine/flame/commit/316a0b3bb0996ed20a3b93175102524b38bfa3e2))
 - **FEAT**: Add `Transform2D.setFrom` and `Transform2D.clone` ([#1495](https://github.com/flame-engine/flame/issues/1495)). ([295468f0](https://github.com/flame-engine/flame/commit/295468f03cde1c02ec9b27b52f387b45edfe54d2))
 ...
 - **FEAT**: Move effects can now be applied to camera's Viewport and Viewfinder ([#1464](https://github.com/flame-engine/flame/issues/1464)). ([bd91fed5](https://github.com/flame-engine/flame/commit/bd91fed5972e342587f49ae27a69b0a7c56e8828))
 - **FEAT**: Add setter for CircleComponent.radius ([#1491](https://github.com/flame-engine/flame/issues/1491)). ([3dd225a2](https://github.com/flame-engine/flame/commit/3dd225a2c8d23b33c708e47e45638418d5a1a415))
 ...
 - **DOCS**: `Rect` extension docs is out of date ([#1451](https://github.com/flame-engine/flame/issues/1451)). ([7e505722](https://github.com/flame-engine/flame/commit/7e505722491dd03fea6d2329ff4df2447143d45b))
 ...
 - **DOCS**: Tutorial for making a Klondike card game, steps 1 & 2 ([#1477](https://github.com/flame-engine/flame/issues/1477)). ([87031b3e](https://github.com/flame-engine/flame/commit/87031b3e5f0c555e9bb8bd381530eef13e96e3b6))
 ...
 - **DOCS**: Added documentation for GameLoop class ([#1234](https://github.com/flame-engine/flame/issues/1234)). ([b1d4e587](https://github.com/flame-engine/flame/commit/b1d4e5872e970f8bd4020a051c35b5cac4093b5e))
 ...
 - **BREAKING** **REFACTOR**: Separate ComponentSet from the Component ([#1266](https://github.com/flame-engine/flame/issues/1266)). ([e2655b88](https://github.com/flame-engine/flame/commit/e2655b8817411ae6b1c505719fed75a170f67aeb))
 ...
 - **BREAKING** **FIX**: Remove pointerId from Draggable callbacks ([#1313](https://github.com/flame-engine/flame/issues/1313)). ([27adda17](https://github.com/flame-engine/flame/commit/27adda17b7b4d8c229cca53799826c7b854eae95))
 ...
 - **BREAKING** **FEAT**(collision detection): Use a broadphase to make collision detection more efficient ([#1252](https://github.com/flame-engine/flame/issues/1252)). ([29dd09ca](https://github.com/flame-engine/flame/commit/29dd09ca925e934f3ca4e266a8a0cdb8ad62ef3b))
 - **BREAKING** **FEAT**(effects): Added SequenceEffect ([#1218](https://github.com/flame-engine/flame/issues/1218)). ([7c6ae6de](https://github.com/flame-engine/flame/commit/7c6ae6def36ae5feb813fb2ba15d6fb3b9aaf341))
...
#### `flame_bloc` - `v2.0.0`
 ...
 - **FIX**: Fix collision detection comments and typo ([#1422](https://github.com/flame-engine/flame/issues/1422)). ([dfeafdd6](https://github.com/flame-engine/flame/commit/dfeafdd6f3e962d6f5148340ab461a9e805652b7))
 - **FEAT**: Components are now always added in the correct order ([#1337](https://github.com/flame-engine/flame/issues/1337)). ([c753fc46](https://github.com/flame-engine/flame/commit/c753fc4636d337d850a5a5cc684be8155f08b214))
 - **FEAT**: publish flame bloc ([#1319](https://github.com/flame-engine/flame/issues/1319)). ([4d5adcb0](https://github.com/flame-engine/flame/commit/4d5adcb0d01d374ca807c71f2b8d963d0781a976))
 ...
 - **FEAT**: flame tests can now generate golden tests ([#1501](https://github.com/flame-engine/flame/issues/1501)). ([316a0b3b](https://github.com/flame-engine/flame/commit/316a0b3bb0996ed20a3b93175102524b38bfa3e2))
 - **FEAT**: Possibility to mark gesture events as handled ([#1465](https://github.com/flame-engine/flame/issues/1465)). ([4c3960c3](https://github.com/flame-engine/flame/commit/4c3960c3418f8ff4d557c1764c6793468238a8da))
 - **FEAT**: Optional Camera argument in FlameBlocGame ([#1331](https://github.com/flame-engine/flame/issues/1331)). ([bcb27f70](https://github.com/flame-engine/flame/commit/bcb27f706f3afcecfe417e065d6c16a6edb1463f))
 - **FEAT**: adding FlameBloc mixin to allow its usage with enhanced FlameGame classes ([#1399](https://github.com/flame-engine/flame/issues/1399)). ([78aab426](https://github.com/flame-engine/flame/commit/78aab42694c66c8b9ea749ac11187f1ed1789a4c))
 ...
 - **DOCS**: Update all README files for the bridge packages to be consistent and not broken ([#2402](https://github.com/flame-engine/flame/issues/2402)). ([5e8ecf54](https://github.com/flame-engine/flame/commit/5e8ecf5450688b1287368b3fbc7b0e718a29fce4))
 - **DOCS**: Update funding links ([#2420](https://github.com/flame-engine/flame/issues/2420)). ([8294a2a1](https://github.com/flame-engine/flame/commit/8294a2a15638c504aa2b77f967f5963af1f23c2c))
 - **DOCS**: Upgrade documentation site ([#1365](https://github.com/flame-engine/flame/issues/1365)). ([12cf8f70](https://github.com/flame-engine/flame/commit/12cf8f70963dc25b4e12182d0c7d80fe7d5a00e0))
 - **DOCS**: Fix various dartdoc warnings ([#1353](https://github.com/flame-engine/flame/issues/1353)). ([9f096053](https://github.com/flame-engine/flame/commit/9f096053fd3c8ebd52d301710625a187db09704f))
 - **DOCS**: Fix typo in flame_bloc readme ([#1332](https://github.com/flame-engine/flame/issues/1332)). ([9bff96bf](https://github.com/flame-engine/flame/commit/9bff96bf3a668fc107c0712aadc6b095ebd50788))
 - **DOCS**: Enable CSpell on tests ([#2723](https://github.com/flame-engine/flame/issues/2723)). ([e051298c](https://github.com/flame-engine/flame/commit/e051298cba76550229780438b1a589557c7b488d))
 - **BREAKING** **FIX**: Migrate from `RawKeyEvent` to `KeyEvent` ([#3002](https://github.com/flame-engine/flame/issues/3002)). ([330862c9](https://github.com/flame-engine/flame/commit/330862c98ecc7ed8d94e7cae0c34cd5781da0007))
 - **BREAKING** **FEAT**: updating flame_bloc to bloc 8 ([#1311](https://github.com/flame-engine/flame/issues/1311)). ([574e0ab5](https://github.com/flame-engine/flame/commit/574e0ab58baa14680cb0d0eded642b4729b062e7))
 - **BREAKING** **FEAT**(collision detection): Use a broadphase to make collision detection more efficient ([#1252](https://github.com/flame-engine/flame/issues/1252)). ([29dd09ca](https://github.com/flame-engine/flame/commit/29dd09ca925e934f3ca4e266a8a0cdb8ad62ef3b))

#### `flame_fire_atlas` - `v2.0.0`
...
#### `flame_forge2d` - `v0.19.0`
 ...
 - **FIX**: Update sdk constraints to >=3.0.0 ([#2554](https://github.com/flame-engine/flame/issues/2554)). ([2f71e06e](https://github.com/flame-engine/flame/commit/2f71e06eb86ffc65cd459c4d722eee2470be13e5))
 - **FIX**: Absolute angle takes into account BodyComponent ancestors too ([#2678](https://github.com/flame-engine/flame/issues/2678)). ([75aee767](https://github.com/flame-engine/flame/commit/75aee767811ef440841956d9e467be157c4ab880))
 - **FIX**: Clone input vector before projecting it ([#1255](https://github.com/flame-engine/flame/issues/1255)). ([d1d6ad4d](https://github.com/flame-engine/flame/commit/d1d6ad4d8c07a5c6895e6120871e336d447ee5a8))
 ...
 - **FIX**: Solve warnings from 3.10.0 analyzer ([#2532](https://github.com/flame-engine/flame/issues/2532)). ([b41622db](https://github.com/flame-engine/flame/commit/b41622db8faa7559328f83f8f1d93ec4c6386961))
 - **FIX**: PositionBodyComponent had an async onMount, without needing ([#1424](https://github.com/flame-engine/flame/issues/1424)). ([7b0fd20a](https://github.com/flame-engine/flame/commit/7b0fd20a2c6d9f6cac0a88877c793608ab4d14c8))
 - **FIX**: SpriteButtonComponent to initialize sprites in `onLoad` ([#3302](https://github.com/flame-engine/flame/issues/3302)). ([1204216c](https://github.com/flame-engine/flame/commit/1204216cb227d3831b546a54818075065fa7beec))
 - **FIX**: Don't use debug rendering by default in BodyComponent ([#1439](https://github.com/flame-engine/flame/issues/1439)). ([33b725e8](https://github.com/flame-engine/flame/commit/33b725e8378d4060e726e99c0452b64f54ef8f67))
 ...
 - **FIX**: Depend on test: any for flame_test ([#2207](https://github.com/flame-engine/flame/issues/2207)). ([acfd418d](https://github.com/flame-engine/flame/commit/acfd418d882ee6872f3aa9961c39680ec123c2e6))
 - **FEAT**: Possibility to mark gesture events as handled ([#1465](https://github.com/flame-engine/flame/issues/1465)). ([4c3960c3](https://github.com/flame-engine/flame/commit/4c3960c3418f8ff4d557c1764c6793468238a8da))
 - **FEAT**: updating forge2d version ([#1479](https://github.com/flame-engine/flame/issues/1479)). ([4678e21a](https://github.com/flame-engine/flame/commit/4678e21a0b714b8344ae2453b1ac6df68adfb4cd))
 - **FEAT**: Added children parameter to Component constructor ([#1525](https://github.com/flame-engine/flame/issues/1525)). ([f0b31fcf](https://github.com/flame-engine/flame/commit/f0b31fcfc0fc6b0f8f96895ef6a68fd5a30a3159))
 - **FEAT**: Add missing optional priority to SpriteBodyComponent ([#1404](https://github.com/flame-engine/flame/issues/1404)). ([a000eb11](https://github.com/flame-engine/flame/commit/a000eb1172ae06ea397d6233c96f2b0ee1f0d93d))
 - **FEAT**: Allow to pass a camera to Forge2D Game ([#1364](https://github.com/flame-engine/flame/issues/1364)). ([9890e9ca](https://github.com/flame-engine/flame/commit/9890e9caada0abc9cd8942b840d72f98853e0cba))
 ...
 - **FEAT**: Bump forg2d version and have flame_forge2d examples use latest syntax ([#1535](https://github.com/flame-engine/flame/issues/1535)). ([4f7a12eb](https://github.com/flame-engine/flame/commit/4f7a12eb2c00d370fd093de4af6a3f9f740aa03a))
 - **FEAT**: ComponentKey API ([#2566](https://github.com/flame-engine/flame/issues/2566)). ([b3efb612](https://github.com/flame-engine/flame/commit/b3efb612cb3cb77f69bc030e9ba71516348035d2))
 - **FEAT**: improving generics on position body component ([#1397](https://github.com/flame-engine/flame/issues/1397)). ([7edbb299](https://github.com/flame-engine/flame/commit/7edbb299855a3926693e846bc1f8e0cbc4272629))
 - **FEAT**: Move to Flutter 3.0.0 and Dart 2.17.0 ([#1713](https://github.com/flame-engine/flame/issues/1713)). ([2a41d0d6](https://github.com/flame-engine/flame/commit/2a41d0d683391194b7209c47bde91199ab7a663e))
 - **FEAT**: Add more lint rules ([#1703](https://github.com/flame-engine/flame/issues/1703)). ([49252f8e](https://github.com/flame-engine/flame/commit/49252f8ef29aa6b77144dcb97c24346f2f39380b))
 ...
 - **FEAT**: `BodyComponent` can properly have normal Flame component children ([#1442](https://github.com/flame-engine/flame/issues/1442)). ([7fe8b6de](https://github.com/flame-engine/flame/commit/7fe8b6deb18b3579fecc99cc44e0ffea73be5f02))
 - **FEAT**: Make ContactCallback begin end methods optional overrides ([#1415](https://github.com/flame-engine/flame/issues/1415)). ([29dd1891](https://github.com/flame-engine/flame/commit/29dd1891b6409ed71c54e05272100dbb180d18e7))
 ...
 - **DOCS**: Fix flame_forge2d readme links ([#1540](https://github.com/flame-engine/flame/issues/1540)). ([c51bc6db](https://github.com/flame-engine/flame/commit/c51bc6db5dbd32283a7e441b450e0dc4636891c6))
 ...
 - **DOCS**: Add Raycast example for flame_forge2d ([#1253](https://github.com/flame-engine/flame/issues/1253)). ([994f27d5](https://github.com/flame-engine/flame/commit/994f27d54ccfaeb1251dd5e95e566611fc967022))
 - **DOCS**: Add AI assist badge to readme(s) ([#3226](https://github.com/flame-engine/flame/issues/3226)). ([380d6aa9](https://github.com/flame-engine/flame/commit/380d6aa946d6b852c55f4ebbfce53d2087287fa2))
 - **BREAKING** **REFACTOR**: Move `CameraComponent` and events out of experimental ([#2505](https://github.com/flame-engine/flame/issues/2505)). ([87b8a067](https://github.com/flame-engine/flame/commit/87b8a067f3e0096cebff3db4f5767e68616928fd))
 - **BREAKING** **FIX**: Migrate from `RawKeyEvent` to `KeyEvent` ([#3002](https://github.com/flame-engine/flame/issues/3002)). ([330862c9](https://github.com/flame-engine/flame/commit/330862c98ecc7ed8d94e7cae0c34cd5781da0007))
 - **BREAKING** **FIX**: Remove pointerId from Draggable callbacks ([#1313](https://github.com/flame-engine/flame/issues/1313)). ([27adda17](https://github.com/flame-engine/flame/commit/27adda17b7b4d8c229cca53799826c7b854eae95))
 - **BREAKING** **FEAT**: Flip gravity in flame_forge2d to be able to mix Forge2D and Flame components ([#1506](https://github.com/flame-engine/flame/issues/1506)). ([bdb360f1](https://github.com/flame-engine/flame/commit/bdb360f18128f9305baa0e6ca77ee6fcad496bc7))
 - **BREAKING** **FEAT**: The `HasTappableComponents` mixin is no longer needed ([#2450](https://github.com/flame-engine/flame/issues/2450)). ([b5bdf4ec](https://github.com/flame-engine/flame/commit/b5bdf4ec173e87907a59a9f62fcdf35cc968af2a))
 - **BREAKING** **FEAT**: Add CameraComponent to FlameGame ([#2740](https://github.com/flame-engine/flame/issues/2740)). ([7c2f4000](https://github.com/flame-engine/flame/commit/7c2f4000761580dbabb5d73b27f64d5819b34e8d))
 - **BREAKING** **FEAT**: Move `Forge2DGame` to use `CameraComponent` ([#2728](https://github.com/flame-engine/flame/issues/2728)). ([7a3d5126](https://github.com/flame-engine/flame/commit/7a3d5126a54d23cdebde20953772a53ba1a53204))
...
#### `flame_rive` - `v2.0.0`
 ...
 - **FIX**: Minor issues due Flutter 3.16 ([#2856](https://github.com/flame-engine/flame/issues/2856)). ([d51cd584](https://github.com/flame-engine/flame/commit/d51cd584c71a27c242c2f4600282cf8359daaa17))
 - **FEAT**: update rive package to 0.8.1 (now support raster graphics) ([#1343](https://github.com/flame-engine/flame/issues/1343)). ([062962de](https://github.com/flame-engine/flame/commit/062962de087cd2a8107b1ae27472095e72bdf847))
...
#### `flame_svg` - `v2.0.0`
 ...
 - **FIX**: SpriteButtonComponent to initialize sprites in `onLoad` ([#3302](https://github.com/flame-engine/flame/issues/3302)). ([1204216c](https://github.com/flame-engine/flame/commit/1204216cb227d3831b546a54818075065fa7beec))
 - **FIX**: Remove memory leak when creating the image from PictureRecorder ([#2493](https://github.com/flame-engine/flame/issues/2493)). ([a66f2bc0](https://github.com/flame-engine/flame/commit/a66f2bc0a97415f4f57b6c55174a2930cdf9e61b))
 - **FIX**: preventing svg rendering from affecting other renderings ([#1339](https://github.com/flame-engine/flame/issues/1339)). ([6e66baa1](https://github.com/flame-engine/flame/commit/6e66baa12fdad7b27f35ca274433acd55165f106))
 - **FIX**: Correct flutter constraint ([#1731](https://github.com/flame-engine/flame/issues/1731)). ([c7383843](https://github.com/flame-engine/flame/commit/c738384314a1a5c3695d1c3adaebcb59604df83a))
 - **FIX**: Exception when having multiple calls to dispose() function of a Svg instance ([#2085](https://github.com/flame-engine/flame/issues/2085)). ([a287904e](https://github.com/flame-engine/flame/commit/a287904eb5dbbe70128207a6f6a56ff98dfbf579))
 ...
 - **FEAT**: Add avoid_final_parameters, depend_on_referenced_packages, unnecessary_to_list_in_spreads ([#1927](https://github.com/flame-engine/flame/issues/1927)). ([deccb434](https://github.com/flame-engine/flame/commit/deccb4349d38b6a91ccf5bdf229980b2a3296ce5))
 - **FEAT**: adding default constructor on SvgComponent ([#1334](https://github.com/flame-engine/flame/issues/1334)). ([00619f80](https://github.com/flame-engine/flame/commit/00619f80475b1e66802a6d2020ea6d521c84059d))
 - **FEAT**: Move to Flutter 3.0.0 and Dart 2.17.0 ([#1713](https://github.com/flame-engine/flame/issues/1713)). ([2a41d0d6](https://github.com/flame-engine/flame/commit/2a41d0d683391194b7209c47bde91199ab7a663e))
 - **FEAT**: Add more lint rules ([#1703](https://github.com/flame-engine/flame/issues/1703)). ([49252f8e](https://github.com/flame-engine/flame/commit/49252f8ef29aa6b77144dcb97c24346f2f39380b))
...
#### `flame_test` - `v2.0.0`
 ...
 - **FIX**: Fix calculation of AABB for `ShapeHitbox`es ([#1481](https://github.com/flame-engine/flame/issues/1481)). ([a559d9a1](https://github.com/flame-engine/flame/commit/a559d9a12bfb42e161469745795fb91cdf161f8b))
 - **FEAT**: Added closeToVector in flame_test ([#1245](https://github.com/flame-engine/flame/issues/1245)). ([af45ea6c](https://github.com/flame-engine/flame/commit/af45ea6cc4b5de80ecb27f07b827f55567cf602b))
 ...
 - **FEAT**(flame_test): Added parameter repeatCount into function testRandom ([#1265](https://github.com/flame-engine/flame/issues/1265)). ([49a2d0b9](https://github.com/flame-engine/flame/commit/49a2d0b9ec00fa9067756dd975e8b3ffd19de0bc))
 - **FEAT**: Add support for styles propagating through the text node tree ([#1915](https://github.com/flame-engine/flame/issues/1915)). ([b5780d42](https://github.com/flame-engine/flame/commit/b5780d421234636144794e663559cec8987656a4))
 - **FEAT**: Add HoverCallbacks ([#2706](https://github.com/flame-engine/flame/issues/2706)). ([d460b846](https://github.com/flame-engine/flame/commit/d460b846c23fb1f67041469c99c81e4c78b89c2e))
 ...
 - **FEAT**: Added closeToAabb() ([#1531](https://github.com/flame-engine/flame/issues/1531)). ([f7b6cc69](https://github.com/flame-engine/flame/commit/f7b6cc69abd6af89cafd892c7f2518b9b7bf3fc6))
 - **FEAT**: Add helper function for creating golden tests ([#1623](https://github.com/flame-engine/flame/issues/1623)). ([d0faaada](https://github.com/flame-engine/flame/commit/d0faaada2bb971c2dde5a37dfa20d316c532ea28))
 - **FEAT**: Move to Flutter 3.0.0 and Dart 2.17.0 ([#1713](https://github.com/flame-engine/flame/issues/1713)). ([2a41d0d6](https://github.com/flame-engine/flame/commit/2a41d0d683391194b7209c47bde91199ab7a663e))
 - **FEAT**: Add more lint rules ([#1703](https://github.com/flame-engine/flame/issues/1703)). ([49252f8e](https://github.com/flame-engine/flame/commit/49252f8ef29aa6b77144dcb97c24346f2f39380b))
 - **FEAT**: Callbacks in `HudButtonComponent` constructor and `ViewportMargin` mixin to avoid code duplication ([#1685](https://github.com/flame-engine/flame/issues/1685)). ([f55b2e0d](https://github.com/flame-engine/flame/commit/f55b2e0dc01c98718e4871430c6745472c221821))
...
#### `flame_tiled` - `v2.0.0`
 ...
 - **FIX**: include layer offset in rendering pipeline ([#1494](https://github.com/flame-engine/flame/issues/1494)). ([1a2b0313](https://github.com/flame-engine/flame/commit/1a2b03131b4290e219827eeb567c965eb3a36f66))
 ...
 - **FIX**: performance improvements on `SpriteBatch` APIs ([#1637](https://github.com/flame-engine/flame/issues/1637)). ([4b19a1b2](https://github.com/flame-engine/flame/commit/4b19a1b203c5cfca5bb412b91c795fe6a215506e))
 - **FIX**(flame_tiled): Add centered anchor point for tile rotation ([#1570](https://github.com/flame-engine/flame/issues/1570)). ([f64d5264](https://github.com/flame-engine/flame/commit/f64d5264abb9e1548d26ae15269654e563cd0ee9))
 ...
 - **FEAT**: Added children parameter to Component constructor ([#1525](https://github.com/flame-engine/flame/issues/1525)). ([f0b31fcf](https://github.com/flame-engine/flame/commit/f0b31fcfc0fc6b0f8f96895ef6a68fd5a30a3159))
 - **FEAT**: Possibility to create RenderableTiledMap from TiledMap ([#1534](https://github.com/flame-engine/flame/issues/1534)). ([5ed08333](https://github.com/flame-engine/flame/commit/5ed08333215658b9eaca049f6ba16b6509901bb9))
 ...
 - **FEAT**: Added getImageLayer to flame_tiled ([#1405](https://github.com/flame-engine/flame/issues/1405)). ([a037ada5](https://github.com/flame-engine/flame/commit/a037ada5ea18b0d1b0be68f9b3d3cceabc8c3b2b))
 - **FEAT**: Expose priority for TiledComponent ([#1259](https://github.com/flame-engine/flame/issues/1259)). ([f6be66ab](https://github.com/flame-engine/flame/commit/f6be66abd5321a8c48f7200d62bd9e35a5aa71ff))
 ...
 - **FEAT**: modifiable Layer and TileData in RenderableTileMap ([#1324](https://github.com/flame-engine/flame/issues/1324)). ([b56d5f3c](https://github.com/flame-engine/flame/commit/b56d5f3cd7d87a07ab0063defbf14a56c0cca1a5))
 - **FEAT**: Add ability to opt-out flip ([#2316](https://github.com/flame-engine/flame/issues/2316)). ([34c3b6bd](https://github.com/flame-engine/flame/commit/34c3b6bdc4c570f4e8641b11b94efe19bdd1ef32))
 ...
 - **DOCS**: Enable CSpell on tests ([#2723](https://github.com/flame-engine/flame/issues/2723)). ([e051298c](https://github.com/flame-engine/flame/commit/e051298cba76550229780438b1a589557c7b488d))
 - **DOCS**: Fix various dartdoc warnings ([#1353](https://github.com/flame-engine/flame/issues/1353)). ([9f096053](https://github.com/flame-engine/flame/commit/9f096053fd3c8ebd52d301710625a187db09704f))
 - **DOCS**: Update flame_tiled readme ([#1286](https://github.com/flame-engine/flame/issues/1286)). ([ee7298cb](https://github.com/flame-engine/flame/commit/ee7298cbe5cd02825cd7246f86ccb0c3655985a0))
 - **DOCS**: Add AI assist badge to readme(s) ([#3226](https://github.com/flame-engine/flame/issues/3226)). ([380d6aa9](https://github.com/flame-engine/flame/commit/380d6aa946d6b852c55f4ebbfce53d2087287fa2))
 - **DOCS**: Update contributions to flame_tiled ([#1197](https://github.com/flame-engine/flame/issues/1197)). ([93b763e1](https://github.com/flame-engine/flame/commit/93b763e1c000b1ebc538e393723aae2a85eb4838))
 - **BREAKING** **FIX**: fix multiple external tilesets ([#1344](https://github.com/flame-engine/flame/issues/1344)). ([80a483f8](https://github.com/flame-engine/flame/commit/80a483f80df57ce6339f84d03d836efcbbf09579))
 - **BREAKING** **FIX**: Migrate from `RawKeyEvent` to `KeyEvent` ([#3002](https://github.com/flame-engine/flame/issues/3002)). ([330862c9](https://github.com/flame-engine/flame/commit/330862c98ecc7ed8d94e7cae0c34cd5781da0007))
 - **BREAKING** **FIX**: Change Tiled batched rendering to batched rendering per layer ([#1317](https://github.com/flame-engine/flame/issues/1317)). ([30fce398](https://github.com/flame-engine/flame/commit/30fce398dbe397d4368a0f721b20afcd663c489f))
 - **BREAKING** **FEAT**: Add CameraComponent to FlameGame ([#2740](https://github.com/flame-engine/flame/issues/2740)). ([7c2f4000](https://github.com/flame-engine/flame/commit/7c2f4000761580dbabb5d73b27f64d5819b34e8d))
...
#### `jenny` - `v1.4.0`
 ...
 - **FEAT**(jenny): Trim whitespace at the end of dialogue lines ([#2149](https://github.com/flame-engine/flame/issues/2149)). ([9c25e631](https://github.com/flame-engine/flame/commit/9c25e631e2e5ed5c593dbca4f498105e2c8fff66))
 ...
 - **FEAT**(jenny): Implement the <<declare>> command ([#2154](https://github.com/flame-engine/flame/issues/2154)). ([8d592f17](https://github.com/flame-engine/flame/commit/8d592f17411800a5239720687149122eaf7750f1))
 - **FEAT**(jenny): Added the <<set>> command ([#2155](https://github.com/flame-engine/flame/issues/2155)). ([2b306d9e](https://github.com/flame-engine/flame/commit/2b306d9ee9c92416fe82b42e9a4ee33b280af46f))
 ...
 - **FEAT**(jenny): Support user-defined commands ([#2168](https://github.com/flame-engine/flame/issues/2168)). ([ffb36a89](https://github.com/flame-engine/flame/commit/ffb36a89efdcd976fe63c16f27741b77b08aa284))
 ...
 - **FEAT**(jenny): Added support for markup attributes ([#2183](https://github.com/flame-engine/flame/issues/2183)). ([f887545b](https://github.com/flame-engine/flame/commit/f887545b127b41412b29217c52f9ec6ea0d6c885))
 ...
 - **FEAT**(jenny): Support commands outside of nodes ([#2145](https://github.com/flame-engine/flame/issues/2145)). ([b313d630](https://github.com/flame-engine/flame/commit/b313d6302d713bda7baee7e90ecdb2fef2a3d6fc))
